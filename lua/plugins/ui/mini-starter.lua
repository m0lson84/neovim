    ...
    opts = function()
      ...
      local config = {
        ...
        items = {
          ...
          new_section('Find files', [[lua require("fzf-lua").files()]], 'Search'),
          new_section('Live grep', [[lua require("fzf-lua").live_grep()]], 'Search'),
          new_section('Recent files', [[lua require("fzf-lua").oldfiles()]], 'Search'),
          new_section('Command history', [[lua require("fzf-lua").command_history()]], 'Search'),
        },
        content_hooks = {
