    ...
    opts = function()
      ...
      local config = {
        ...
        items = {
          ...
          new_section('Find files', 'Telescope find_files', 'Telescope'),
          new_section('Live grep', 'Telescope live_grep', 'Telescope'),
          new_section('Recent files', 'Telescope oldfiles', 'Telescope'),
          new_section('Command history', 'Telescope command_history', 'Telescope'),
        },
        content_hooks = {
