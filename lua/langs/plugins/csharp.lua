    ...
    opts = {
      servers = {
        omnisharp = {
          ...
          keys = {
            { 'gd', goto_definition, desc = 'goto [d]efinition' },
            { 'gi', goto_implementation, desc = 'goto [i]mplementation' },
            { 'gr', find_all_references, desc = 'find all [r]eferences' },
            { '<leader>D', goto_type_definition, desc = 'goto type [D]efinition' },
          },
          settings = {
            FormattingOptions = {
