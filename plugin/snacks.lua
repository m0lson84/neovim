...
vim.keymap.set('n', '<leader>gb', function() Snacks.picker.git_log_line() end, { desc = 'git [b]lame line' })
vim.keymap.set('n', '<leader>gf', function() Snacks.picker.git_log_file() end, { desc = 'git [f]ile history' })
