...
require('mini.icons').setup({
  ...
  file = {
    ...
    ['AGENTS.md'] = { glyph = '󰚩', hl = 'MiniIconsRed' },
    ['biome.json'] = { glyph = '', hl = 'MiniIconsBlue' },
    ['bun.lock'] = { glyph = '', hl = 'MiniIconsGray' },
    ['bunfig.toml'] = { glyph = '', hl = 'MiniIconsGray' },
    ...
    ['vitest.config.ts'] = { glyph = '', hl = 'MiniIconsAzure' },
